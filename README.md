...
## Gameplay:
- Em Bosque Galdua, o jogador controla o guardião da floresta **Artamus**, que possui uma espada. O jogador explora sete níveis: a vila ancestral, a floresta, a árvore, a ponte, a segunda árvore, a arena e os arredores. Os níveis duram cerca de um minuto à dois minutos.
...
- A vila ancestral, um lugar cheio de casas destruídas, que funciona como cenário introdutório e tutorial.
- ![Floresta](https://i.ibb.co/S0LTB0x/Floresta.png)
- A floresta principal é cheia de árvores e gramíneas e é infestada pela maior variedade de inimigos.
...
- A grande ponte, um local perigoso e cheio de inimigos e obstáculos que conecta as duas grandes árvores importantes da floresta; abaixo da ponte, um local de exploração alternativo com menos inimigos e mais enigmas, comparado à ponte.
...
## Mecânicas:
- Andar: O jogador pode andar no eixo x utilizando as teclas A e D.
- Pular: O jogador pode pular e se movimentar no eixo y utilizando a tecla Espaço, sendo a altura do pulo determinadaa pelo tempo no qual a tecla ficou segurada, até um ponto máximo.
- Atacar: Como player você pode atacar tanto lateralmente quanto para cima utilizando para atacar lateralmente a tecla J, e para cima W + J.
- Empurrar: Você como jogador pode empurrar caixas ou outros *props* para resolver enigmas.
- Agarrar e tacar objetos: O jogador consegue segurar certos objetos utilizando o botão de ataque, e taca-los utilizando a mesma tecla.
- Pular em paredes: Ao encostar em uma parede, o jogador pode manter a tecla segurada para deslizar lentamente sobre a parede ou apertar a tecla de pulo para pular para o outro lado.
- Planar: Após pular e soltar o botão de pulo, o jogador pode pressionar o mesmo botão para diminuir a velocidade de sua queda.
## Power-Ups:
